  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="flex justify-between items-center px-6 py-4 border-b border-zoom-border">
          <h2 className="text-lg font-bold text-gray-800">Join Meeting</h2>
        ...
        <form onSubmit={handleJoin} className="p-6">
          <div className="space-y-4">
            ...
            <div className="pt-2 space-y-3">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 text-zoom-blue rounded border-gray-300 focus:ring-zoom-blue" />
          ...
          <div className="mt-8 flex justify-end gap-3">
            ...
            <button 
              ...
              className="px-6 py-2 rounded-lg font-medium text-white bg-zoom-blue hover:bg-zoom-blue-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Join
            </button>
          </div>
